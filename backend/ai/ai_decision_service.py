...
async def create_ai_decision(company_id: str, user_id: str):
    ...
    try:
        ...
        raise HTTPException(502, "Decisão do agente rejeitada pela validação") from exc
    ...
    doc = {
        ...
        "company_id": company_id,
        "user_id": user_id,
        "agent": orchestrator.engine.name,
        "agent_version": orchestrator.engine.version,
        "model": getattr(orchestrator.engine, "model", None),
